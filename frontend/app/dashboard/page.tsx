        ...
        <main className="max-w-[1200px] mx-auto px-6 py-8 relative z-10 w-full flex-1 flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div className="bg-[#0a0a0a] border border-zinc-800 rounded-xl p-5 flex flex-col shadow-sm">
              ...
              <div className="flex flex-col gap-1.5">
                <div className="flex justify-between items-baseline">
                  ...
                  <span className="text-[11px] font-medium text-emerald-400">XLM</span>
                </div>
                <div className="flex justify-between items-baseline">
                  <span className="text-xl font-semibold text-white">{usdcBalance}</span>
                  <span className="text-[11px] font-medium text-blue-400">USDC</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#0a0a0a] border border-zinc-800 rounded-xl p-5 flex flex-col shadow-sm">
              ...
              <div className="text-[10px] font-semibold text-purple-400 bg-purple-400/10 border border-purple-400/20 px-2 py-0.5 rounded w-fit">
                Verified On-Chain
              </div>
            </div>
          </div>
